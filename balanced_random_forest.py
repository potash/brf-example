...
kddtrain = pd.read_csv('data/kddcup.data_10_percent.gz', compression='gzip')  #http://kdd.ics.uci.edu/databases/kddcup99/kddcup.data_10_percent.gz
kddtest = pd.read_csv('data/corrected.gz', compression='gzip') #'http://kdd.ics.uci.edu/databases/kddcup99/corrected.gz'
...
common_params={'n_estimators':500, 'criterion':'entropy', 'n_jobs':-1}
